...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(input_size, self.hparams["encoder_hidden_size_1"]),
            nn.ReLU(),
            nn.Linear(self.hparams["encoder_hidden_size_1"], self.hparams["encoder_hidden_size_2"]),
            nn.ReLU(),
            nn.Linear(self.hparams["encoder_hidden_size_2"], self.hparams["encoder_hidden_size_3"]),
            nn.ReLU(),
            nn.Linear(self.hparams["encoder_hidden_size_3"], latent_dim)
        )
        ########################################################################
        #                           END OF YOUR CODE                           #
        ########################################################################
...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=20, output_size=28 * 28):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(latent_dim, self.hparams["decoder_hidden_size_1"]),
            nn.ReLU(),
            nn.Linear(self.hparams["decoder_hidden_size_1"], self.hparams["decoder_hidden_size_2"]),
            nn.ReLU(),
            nn.Linear(self.hparams["decoder_hidden_size_2"], self.hparams["decoder_hidden_size_3"]),
            nn.ReLU(),
            nn.Linear(self.hparams["decoder_hidden_size_3"], output_size)
        )
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        self.input_size = self.encoder.latent_dim
        self.model = nn.Sequential(
            nn.Linear(self.input_size, self.hparams["classifier_hidden_size_1"]),
            nn.ReLU(),
            nn.Linear(self.hparams["classifier_hidden_size_1"], self.hparams["classifier_hidden_size_2"]),
            nn.ReLU(),
            nn.Linear(self.hparams["classifier_hidden_size_2"], self.hparams["classifier_hidden_size_3"]),
            nn.ReLU(),
            nn.Linear(self.hparams["classifier_hidden_size_3"], 10)
        )
